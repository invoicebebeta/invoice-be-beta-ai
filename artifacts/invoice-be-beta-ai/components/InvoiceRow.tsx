        ...
        <View style={styles.topRow}>
          <View style={{ flex: 1, marginRight: 12 }}>
            ...
            {invoice.invoiceNumber ? (
              <Text style={[styles.invNum, { color: colors.mutedForeground }]}>{invoice.invoiceNumber}</Text>
            ) : null}
          </View>
...
const styles = StyleSheet.create({
  ...
  customer: { fontFamily: 'Inter_600SemiBold', fontSize: 15 },
  invNum: { fontFamily: 'Inter_400Regular', fontSize: 11, marginTop: 2, letterSpacing: 0.3 },
